...
curl -X POST "https://parallax-api-dev.herokuapp.com/api/image" -H  "accept: */*" -H  "Content-Type: multipart/form-data" -F data="{'effect': 'mura masa'}" -F "image=@woman.PNG;type=image/png"
